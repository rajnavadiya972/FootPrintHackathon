    ...
    return (
        <div className='text-white flex h-screen'>
            ...
            <div className='justify-center align-middle mt-10  mx-auto px-10'>
                ...
                <button className='bg-gray-500 p-2 rounded-lg mb-5 mx-auto hover:bg-gray-600' >Mark all read</button>
                <div className='flex  mx-10 '>
                    ...
                    <button className=' mx-2 bg-gray-500 my-5 px-2 rounded-lg hover:bg-gray-600' >Mark as Read</button>
                </div>
            </div>
        </div>
    )
